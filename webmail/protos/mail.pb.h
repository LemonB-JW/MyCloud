...
class MailReply final :
 ...
 public:
  ...
  const ::mail::Email& email() const;
  ::mail::Email* release_email();
  ::mail::Email* mutable_email();
  void set_allocated_email(::mail::Email* email);
...
// .mail.Email email = 1;
inline bool MailReply::has_email() const {
  return this != internal_default_instance() && email_ != nullptr;
}
inline void MailReply::clear_email() {
  if (GetArenaNoVirtual() == nullptr && email_ != nullptr) {
    delete email_;
  }
  email_ = nullptr;
}
inline const ::mail::Email& MailReply::email() const {
  const ::mail::Email* p = email_;
  // @@protoc_insertion_point(field_get:mail.MailReply.email)
  return p != nullptr ? *p : *reinterpret_cast<const ::mail::Email*>(
      &::mail::_Email_default_instance_);
}
inline ::mail::Email* MailReply::release_email() {
  // @@protoc_insertion_point(field_release:mail.MailReply.email)
  
  ::mail::Email* temp = email_;
  email_ = nullptr;
  return temp;
}
inline ::mail::Email* MailReply::mutable_email() {
  
  if (email_ == nullptr) {
    auto* p = CreateMaybeMessage<::mail::Email>(GetArenaNoVirtual());
    email_ = p;
  }
  // @@protoc_insertion_point(field_mutable:mail.MailReply.email)
  return email_;
}
inline void MailReply::set_allocated_email(::mail::Email* email) {
  ...
  email_ = email;
  // @@protoc_insertion_point(field_set_allocated:mail.MailReply.email)
}
