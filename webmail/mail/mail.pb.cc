...
const ::google::protobuf::uint32 TableStruct_mail_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::mail::MailReply, item_),
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_mail_2eproto[] =
  ...
  "r\030\001 \001(\t\"&\n\tMailReply\022\031\n\004item\030\001 \003(\0132\013.mai"
  "l.Email\"E\n\005Email\022\014\n\004from\030\001 \001(\t\022\017\n\007subjec"
  "t\030\002 \001(\t\022\014\n\004date\030\003 \001(\t\022\017\n\007content\030\004 \001(\t27"
  "\n\004Mail\022/\n\007GetMail\022\021.mail.MailRequest\032\017.m"
  "ail.MailReply\"\000B+\n\025io.grpc.examples.mail"
  "B\tMailProtoP\001\242\002\004MAILb\006proto3"
  ;
::google::protobuf::internal::DescriptorTable descriptor_table_mail_2eproto = {
  ...
  "mail.proto", &assign_descriptors_table_mail_2eproto, 268,
};
...
#if !defined(_MSC_VER) || _MSC_VER >= 1900
const int MailReply::kItemFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900
